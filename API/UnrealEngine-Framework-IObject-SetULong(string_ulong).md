...
## IObject.SetULong(string, ulong) Method
  
```csharp
bool SetULong(string name, ulong value);
```
#### Parameters
<a name='UnrealEngine-Framework-IObject-SetULong(string_ulong)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-IObject-SetULong(string_ulong)-value'></a>
