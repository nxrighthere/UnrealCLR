...
## PlayerController.PlayerController(string, Blueprint) Constructor
Spawns the actor in the world  
```csharp
public PlayerController(string name=null, UnrealEngine.Framework.Blueprint blueprint=null);
```
#### Parameters
<a name='UnrealEngine_Framework_PlayerController_PlayerController(string_UnrealEngine_Framework_Blueprint)_name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
The name of the actor
  
<a name='UnrealEngine_Framework_PlayerController_PlayerController(string_UnrealEngine_Framework_Blueprint)_blueprint'></a>
