...
## IObject.GetUInt(string, uint) Method
  
```csharp
bool GetUInt(string name, ref uint value);
```
#### Parameters
<a name='UnrealEngine-Framework-IObject-GetUInt(string_uint)-name'></a>
`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
  
<a name='UnrealEngine-Framework-IObject-GetUInt(string_uint)-value'></a>
